...
public class WaypointOverlayAdapter extends ArrayAdapter<Waypoint> {
    Drawable m_drawHide;
    ...
    public WaypointOverlayAdapter(Context context, int textViewResourceId, List<Waypoint> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (((Waypoint) getItem(position)).m_bVisible) {
            if (getItem(position) == MMTrackerActivity.m_NavigationTarget.m_Waypoint && MMTrackerActivity.m_NavigationTarget.m_Type == NavigationTarget.TARGET_TYPE_WAYPOINT) {
        ...
        } else if (getItem(position) == MMTrackerActivity.m_NavigationTarget.m_Waypoint && MMTrackerActivity.m_NavigationTarget.m_Type == NavigationTarget.TARGET_TYPE_WAYPOINT) {
        ...
        label.setText(((Waypoint) getItem(position)).toString());
        return v;
    }
}
